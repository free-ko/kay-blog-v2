            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                  팀원들이 Cursor, Claude Code 등 각자 다른 AI 도구를 활용하면서
                  생성되는 코드 스타일이 제각각이었습니다. 3개월 후 이 코드를
                  수정할 동료를 생각하면 방치할 수 없었습니다.
                  <br />
                  이를 해결하기 위해 팀 회의를 주도하여 모든 AI 도구가 참조하는
                  통합 컨벤션 문서 Agent.md를 함께 작성했습니다. 사람이 작성하든
                  AI가 생성하든 동일한 기준의 코드가 만들어지도록 설계했고,
                  합의된 컨벤션을 ESLint 커스텀 패키지로 구현한 뒤 husky를 통해
                  커밋 시점에 자동 검증되도록 구성했습니다.
                  <br />
                  덕분에 PR 리뷰에서 코드 스타일 논의가 사라지고 로직과 설계에
                  집중할 수 있게 되었습니다.
                </p>
              </div>
