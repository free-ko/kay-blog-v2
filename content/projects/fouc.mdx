---
title: 'FOUC 해결방법'
description: Emotion을 사용할 때 발생하는 FOUC 해결방법을 알아보자.
date: '2024-11-15 07:22:00'
published: true
---
...
- `DisableTransitionsOnLoad` 컴포넌트로 초기 전환 효과 비활성화
...
- `_document.tsx` 설정으로 SSR 스타일 최적화
