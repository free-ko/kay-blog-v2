...
description: 'React-Hook-Form과 Formik 차이를 알아보자.'
date: '2024-07-24 06:40:00'
published: true
---
...
![](https://blog.logrocket.com/wp-content/uploads/2019/10/formik-re-renders.gif)

### React Hook Form

<b>총 랜더링 수 3</b>

![](https://blog.logrocket.com/wp-content/uploads/2019/10/react-hook-form-re-renders.gif)
...
Formik을 포함한 다른 라이브러리는 단일 Form 값 변경에 대해 전체 Form이 연결되어 있어, 전체 Form과 유연하다는 관점에서는 장점이 있으나, 거대한 랜더링 비용이 드는 건 사실입니다.
...
![](https://blog.logrocket.com/wp-content/uploads/2019/10/image4.png)
...
![](https://blog.logrocket.com/wp-content/uploads/2019/10/image2.png)
...
![](https://free-ko.github.io/static/fc4674f14f1c718c9fec0ef841ceadbf/a016c/feature.png)
...
const InputField = ({ ...props }) => {
  ...
  // 디자인 시스템 Input 컴포넌트
  return <Input {...field} errorText={errorMessage} isError={!!errorMessage} />;
};
```
