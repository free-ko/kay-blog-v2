...
// 변경 후
functino component({ value }) {
	const [copyValue] = useMemo(() => 무거운_연산(vlaue), [value])
...
function component(props) {
  <HeaderComponent hasPdding={props.hasPadding}>
    <ChildComponent isDarkMode={props.isDrakMode} isLogin={props.isLogin} />
  </HeaderComponent>;
}

// 변경 후
function component({ hasPadding, ...props }) {
  <HeaderComponent hasPdding>
